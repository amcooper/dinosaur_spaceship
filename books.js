  ...
  if (urlArr[2] === "style.css") {
    ...
    fs.readFile("sindex.html" , function(err,data1) {
      ...
      fs.readFile( library[urlArr[1]] , function(err,data2) {
        ...
        result = result.replace("pBack", "http://adam.princesspeach.nyc:2000/" + urlArr[1] + "/" + (parseInt(urlArr[2]) - 1)+" ");
        ...
        if (urlArr[2] < totalPages) {
          result = result.toString().replace("pNext", "http://adam.princesspeach.nyc:2000/" + urlArr[1] + "/" + (parseInt(urlArr[2]) + 1));
